...
const STRATEGIES: Strategy[] = [
  ...
  },
  {
    ...
    keyPoints: [
      'Level 1: 5% daily loss → 1 hour pause',
      'Level 2: 10% daily → rest of day halt',
      'Level 3: 15% weekly → week halt',
    ...
    workflow: [
      ...
      'If daily loss > 5%: Level 1 trigger',
      'If daily loss > 10%: Level 2 trigger',
      'Halt all trading for cooldown period',
  ...
  // Based on analysis of top profitable traders on X/Twitter
  {
    id: 'btc_bracket_arb',
    ...
    keyPoints: [
      ...
      'Focus on Polymarket BTC up/down brackets',
      'Scan every 15 seconds for opportunities',
      '0% fees on Polymarket = pure profit',
