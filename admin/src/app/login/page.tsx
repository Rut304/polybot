      ...
      >
        ...
        <div className="bg-dark-card border border-dark-border rounded-2xl p-8">
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            ...
            <Link href="/signup" className="text-neon-blue hover:text-neon-green transition-colors font-medium">
              Sign up free
            </Link>
          </p>
        </div>
        ...
        <p className="text-center mt-6">
          <Link href="/landing" className="text-sm text-gray-500 hover:text-gray-300 transition-colors">
            ← Back to home
          </Link>
        </p>
      </motion.div>
