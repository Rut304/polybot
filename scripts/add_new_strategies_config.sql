...
ALTER TABLE polybot_config 
ADD COLUMN IF NOT EXISTS political_event_categories TEXT DEFAULT 'election,legislation,hearing';
...
ALTER TABLE polybot_config 
ADD COLUMN IF NOT EXISTS high_conviction_min_score DECIMAL(5,2) DEFAULT 0.75;
...
ALTER TABLE polybot_config 
ADD COLUMN IF NOT EXISTS selective_whale_min_win_rate DECIMAL(5,2) DEFAULT 0.65;
